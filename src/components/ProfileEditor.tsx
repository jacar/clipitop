              ...
              <div className="border-4 border-gray-300 rounded-3xl overflow-hidden relative" style={{ aspectRatio: '9/19.5' }}>
                ...
                >
                  <div className="p-8 flex flex-col items-center">
                    ...
                    />
                    <h1 className="text-2xl mb-2" style={{ color: textColor }}>
                      {displayName}
                    </h1>
                    ...
                    <div className="w-full space-y-3 mb-6">
                      {links.map((link) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block w-full py-3 px-4 bg-white rounded-full text-center shadow-md hover:scale-105 transition"
                    ...
                    {galleryImages.length > 0 && (
                      <div className="w-full">
                        <h3 className="text-lg mb-3" style={{ color: textColor }}>
                          Galería
                        </h3>
