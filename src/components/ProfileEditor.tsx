...
export function ProfileEditor({ onClose, user, onLogout, selectedTemplate, onNavigate }: ProfileEditorProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex fixed bottom-4 right-4 flex-col items-center gap-2 z-[10000] bg-white/90 backdrop-blur p-4 rounded-xl shadow-2xl border border-white/20 transition-all hover:scale-105">
