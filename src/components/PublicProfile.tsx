      ...
      {/* WhatsApp Floating Button */}
      {
        profile.whatsapp_active && profile.whatsapp_number && (
          <a
            ...
            className={`fixed bottom-6 ${profile.whatsapp_position === 'left' ? 'left-6' : 'right-6'} z-50 text-white p-4 rounded-full shadow-lg hover:scale-110 transition-all duration-300 flex items-center justify-center hover:brightness-110`}
